...
cov_filepath = '/Volumes/group/awagner/sgagnon/exp_name/data/covariate.csv' # rows = subjs, cols = (subids + covariate)
cov_col = 'covariate_name' # this is column name for covariate values (it'll be z-scored below)
