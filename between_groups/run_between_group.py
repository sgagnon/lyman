...
group_filepath = '/filepath/subjects_groups.csv'
contrast_name = "group1-group2" #"group2-group1"
contrast_vals = [1, -1] # [-1, 1]
...
def parse_args(arglist):
    ...
    parser.add_argument("-output", default="group1-group2",
